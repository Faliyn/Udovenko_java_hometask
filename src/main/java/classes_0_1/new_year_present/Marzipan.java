...
public class Marzipan extends Candy {
   ...
   private boolean fresh;
    ...
    public String toString() {
        return "Marzipan{"+ "name=" + getName() + ", persant_of_sugar=" + getPersant_of_sugar() + ", weight=" + getWeight() + 
    ...
    public Marzipan(int callories, boolean fresh, String name, double persant_of_sugar, double weight, String vendor, int price) {
